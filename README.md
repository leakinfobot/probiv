...
[OpenData](https://bit.ly/4dGzZPk) — Бесплатный OSINT бот, парсит данные только по открытым источникам и весьма не плохо. Инфу собирает о никах, ID телеги, ищет сообщения пользователя Телеграмм, GSM инфа, инфа о IP и MAC, Вк профиле, и много чего интересного.
...
[Getairplane](https://bit.ly/3SmbHSH) — предоставляет бесплатную информацию о полетах по номеру телефона за последние 20 лет, с ограничением на три строки данных.
...
[TgScanRobot](https://bit.ly/4cNpjPc) — это инструмент для поиска телеграм-групп, в которых состоит человек. Для каждой найденной группы указывается дата, когда TgScanRobot бот видел там в последний раз искомого пользователя. Платный но реально рабочий.

[FunstatBot](https://t.me/FunStatBot0bot?start=0101F80C2D1500000000) — умеет находить историю изменений ID, находит сообщения в чатах, а также способен обнаружить телефонные номера. Отслеживает активность пользователей в группах, анализирует сообщения, определяет возраст и предпочтения, а также находит адреса Email. Бот также позволяет узнать, в каких каналах состоит юзер, какой канал или чат посещает чаще всего. Может следить за пользователем.
...
[Unamer](https://t.me/unamer_bot) — бот который вам поможет при поиске информации о Telegram-Аккаунте, пока что, он сообщает о том, какие пользователи владели тем, или иным никнеймом, абсолютно бесплатно.
...
[Telegram DB](https://bit.ly/3WwzG41) — помогает находить общедоступные каналы и группы цели, а также показывает, в каких публичных чатах присутствует.
...
[Universal Search](https://bit.ly/3WvNWdl) — Бот предназначенный для поиска исключительно открытой информации по таким запросам, как: номер телефона, адрес электронной почты, госномер автомобиля, имя пользователя, IP-адрес, доменное имя, геолокация, фотография, ID Telegram и ВКонтакте. Прекрасно автоматизирует OSINT.

[Social Graph](https://bit.ly/4bZfexk) — Составляет граф друзей по публичному профилю, показывая, кто с кем дружит, и выделяя группы родственников, коллег, одноклассников и другие связи.

[FindNameVk](https://bit.ly/4c2NMOZ) — находит историю изменения фамилий профиля из открытых источников и указывает дату создания аккаунта.
...
[Search4Faces](https://bit.ly/3zSgW6d) — бесплатный бот сервиса search4faces, который ищет людей по фотографии. Если он найдет фото в профиле VK, то покажет соответствующий профиль.
